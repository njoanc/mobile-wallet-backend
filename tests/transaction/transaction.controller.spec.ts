...
import { VerifyWebhookDto } from '../../src/transaction/dto/verify-webhook.dto';
    ...
    it('should view all transactions by a particular user', async () => {
      try {
        ...
        const controllerResult =
          await controller.getUserTransactions(innerParam);
      ...
      try {
        ...
        webhook.body = {
          ...
          customer: {
            id: 1658845,
            phone: null,
            fullName: 'Edmond Kirsch-32ecd7f0-ebf2-474c-b7df-84420ecd8840',
            customertoken: null,
          ...
          entity: {
            ...
            first_name: 'Edmond',
            last_name: 'Kirsch-32ecd7f0-ebf2-474c-b7df-84420ecd8840',
            createdAt: '2022-06-14T23:48:24.000Z',
          },
          'event.type': 'ACCOUNT_TRANSACTION',
        };
        let req: any;
        const controllerResult = await controller.verifyWebhook(webhook, req);
